...
export default function Home() {
    return (
        <main className="flex-1">
            <div className="pt-[32px] xl:pb-[107px] xl:pt-[86px] bg-white relative ">
      ...
      <Rating />
            ...
            <div className="border xl:h-[246px] flex flex-col items-center bg-gray-100 xl:space-y-[15px]">
                <p className="xl:mt-[96px] text-[#0052D9] xl:text-[25px]">Cargo Tracking</p>
                <div className='flex relative'>
                    <div className="xl:w-[480px] xl:h-[60px] relative bg-white flex items-center justify-center border-[var(--blue)] border-[2px]">
                        <p className="text-[var(--blue)] xl:text-[24px]">https://www.google.com.hk</p>
                    </div>
