...
export default function Home() {
    return (
        <main className="flex-1">
            <div className="pb-[107px]  pt-[86px] bg-white relative "
            >
                <Description title="Shipping method" className="text-xl font-bold">
                    <div className="mt-[24px] grid grid-cols-3
                                    gap-[56px]">
                ...
                <div className="mt-[104px]">
                    <Description title="Value Added service" className="text-xl font-bold">
                        <div className="mt-[24px] grid grid-cols-3
                                    gap-[56px] ">
            ...
            <div className="border h-[246px] flex flex-col items-center bg-gray-100 space-y-[15px]">
                <p className="mt-[96px] text-[#0052D9] text-[25px]">Cargo Tracking</p>
                <div className='flex relative'>
                    <div className="w-[480px] h-[60px] relative bg-white flex items-center
                                    justify-center border-[var(--blue)] border-[2px]">
                        <p className="text-[var(--blue)] text-[24px]">https://www.google.com.hk</p>
                    </div>
