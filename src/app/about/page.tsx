        ...
        <main className='bg-white'>
            <section className='flex flex-col items-center md:flex-row items-center md:items-start pl-[26px] pr-6 xl:pl-[70px] xl:pr-[95px] xl:pt-[67px] pt-[25px] xl:space-x-[62px] space-x-[23px]'>
                ...
                <div className='w-[100%] md:w-[50%]'>
                    <h3 className='text-center text-[8px] font-bold text-[var(--blue)] md:text-xl pt-[6px] lg:pt-[16px]'>About us</h3>
                    <div className='space-y-1 lg:space-y-2 relative'>
                        <p className='text-[7px] md:text-[12px] lg:text-[13px] xl:text-[14px] text-[#2F2F2F] md:leading-[1.4em] tracking-[0.01em] lg:leading-[30px] lg:tracking-[0.02em]'>
                        ...
                        <p className='text-[7px] md:text-[12px] xl:text-[14px] text-[#2F2F2F] md:leading-[1.4em] md:tracking-[0.01em] lg:leading-[30px] xl:tracking-[0.02em]'>
                        ...
                        <p className='text-[7px] md:text-[12px] xl:text-[14px] text-[#2F2F2F] md:leading-[1.4em] tracking-[0.01em] lg:leading-[30px] lg:tracking-[0.02em]'>
